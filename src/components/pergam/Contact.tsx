      ...
      <div className="max-w-5xl mx-auto px-6">
        <div className="relative card-surface rounded-3xl p-10 md:p-16 text-center overflow-hidden glow-purple-sm">
          ...
          <div className="relative">
            <p className="text-sm uppercase tracking-[0.2em] text-primary mb-3">Kontak</p>
            <h2 className="font-display text-3xl md:text-5xl font-bold">
              Siap mulai? <span className="gradient-text text-glow">Order Sekarang</span>
            </h2>
            <p className="mt-4 text-muted-foreground max-w-xl mx-auto">
              Hubungi tim Pergam Store via WhatsApp untuk pesanan cepat, atau ikuti Instagram kami
              untuk info stock terbaru.
            </p>
