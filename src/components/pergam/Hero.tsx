  ...
  return (
    <section id="hero" className="relative pt-32 pb-24 md:pt-44 md:pb-36 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 text-center">
        ...
        <h1
          className="font-display text-4xl sm:text-5xl md:text-7xl font-bold leading-[1.05] animate-fade-up"
          style={{ animationDelay: "0.1s" }}
        >
          Trusted Game Account
          <br />
          <span className="gradient-text text-glow">Rental & Stock</span> Marketplace
        </h1>
        ...
        >
          Check availability of Free Fire, Mobile Legends, and rental accounts easily and quickly —
          semua dalam satu tempat aman.
        </p>
        ...
        >
          {[
            ...
            <div key={s.l} className="card-surface rounded-2xl p-4 hover-lift">
